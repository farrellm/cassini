...
| `symbolica_home_2025_wayback.html` | The same page on 2025-04-15, added in the fourth round for the same reason: the directory file asserted what 2025 snapshots said with nothing held on that side. They say "Symbolica is an **easy-to-use library for Python and Rust**" — a third distinct tagline, and a third capture in which "built for large expressions" does not appear. |
