...
| `numeric_prelude_haskellwiki.html` | **Not the argument** — none of the four objections above appear in this capture. What it adds is the list of supported algebraic structures and object types, and a candid *Future plans* section: "the code still misses proper linear algebra code", with static checking unsolved for "residue classes, matrix computations, infinite precision numbers, fixed point numbers". |
