...
| `schneider2007_symbolic_summation_assists_combinatorics.pdf` | **The other half of symbolic summation**: difference fields, and the Sigma package built on Karr's algorithm. This is what *A=B* leaves out. 36 pp., free. Karr's own two papers are paywalled and not held — start here instead. |
